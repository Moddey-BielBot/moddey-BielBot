...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Moddey\n' 
            + 'ORG:Gabriel;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=5511972023320:+55 11972023320\n' 
            + 'END:VCARD'
prefix = '!'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: '[👨🏻‍💻]Aguarde, Preciso pensar um pouco para fazer isso',
					success: '️❬ ✔ ❭ Sucesso 🖤',
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD MODDEY BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗]  Este é um recurso especial para o Moddey ❌',
					ownerB: '[❗]  Este é um recurso especial para o Moddey ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo. Registre-se para fazer amizade com o bot  por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Moddey|17\n\n──「 MODDEY BOT 」──`,
			...
			const ownerNumber = ["5511972023320@s.whatsapp.net"] 
			const mod = [ownerNumber,"5511972023320@s.whatsapp.net"]
			const adminbotnumber = ["5511972023320@s.whatsapp.net"]
			const frendsowner = ["5511972023320@s.whatsapp.net"]
			const premium = ["5511972023320@s.whatsapp.net","55117023320@s.whatsapp.net"] 
...
// recursos anime, random @Causs domina vida
          ...
          reply('Espere..')
			    ...
			    case 'owner':
                    ...
                    client.sendMessage(from, 'este número e do meu criador😳😳',MessageType.text, { quoted: mek} )
                    break
                case 'fitnah':	
				case 'fake':          
                    if (!isGroup) return reply(mess.only.group)
        ...
        case 's':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do Moddey:*\n\n https://youtube.com/channel/'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
